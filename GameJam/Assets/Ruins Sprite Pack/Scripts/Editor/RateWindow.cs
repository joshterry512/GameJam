...
public class RateWindow : EditorWindow
{
    ...
    [MenuItem("Forest Parallax Backgrounds/RateWindow")]
    ...
    private void OnGUI()
    {
        ...
        string titleText = "Hey! Thanks for acquiring the Forest Parallax Backgrounds!";
        string bodyText = "Just wanted to ask you to spare a few seconds to give a rating to the Forest Parallax Backgrounds on the store. It will help tremendously to support further development of the package.\n\n" +
                          "Thanks again! \n";
        ...
        if (GUILayout.Button("Rate Forest Parallax Backgrounds!", GUILayout.Height(30), GUILayout.MaxWidth(300)))
        {
            Application.OpenURL("http://u3d.as/YMT");
        }
